    ...
    <div class="flex">
      <div class="w-full lg:w-8/12 mr-6">
        <div class="w-full mb-8">
          <div class="bg-gray-200 transform -rotate-2 rounded-2xl">
            ...
            >
              <label
                class="block uppercase text-xs text-blue-100 font-semibold tracking-wider mb-1"
                >balances</label
              >
        ...
        <div class="flex items-center -mx-2">
          <div class="w-full px-2">
            <div class="bg-gray-200 transform -rotate-3 rounded-2xl">
              ...
              >
                <label
                  class="block uppercase text-xs text-teal-100 font-semibold tracking-wider mb-1"
                  >debit</label
                >
          ...
          <div class="w-full px-2">
            <div class="bg-gray-200 transform -rotate-3 rounded-2xl">
              ...
              >
                <label
                  class="block uppercase text-xs text-red-100 font-semibold tracking-wider mb-1"
                  >credit</label
                >
            ...
            <div class="h-112 overflow-y-scroll">
              ...
              >
                <router-link
                  ...
                  class="px-6 py-4 flex justify-between items-center hover:bg-gray-100 border-b"
                >
      ...
      <div class="w-full lg:w-4/12">
        ...
        <form @submit.prevent="add">
          ...
          <button
            class="px-4 h-10 rounded-lg focus:ring focus:ring-blue-300 bg-blue-500 hover:bg-blue-600 text-white"
          >
            Add Transaction
          </button>
        </form>
