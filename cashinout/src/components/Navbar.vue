<template>
  <div class="border-b lg:py-3">
    <div class="flex flex-col lg:flex-row justify-between">
      ...
      <div
        :class="isOn ? 'block' : 'hidden'"
        class="flex py-4 lg:flex lg:py-0 flex-col lg:flex-row justify-between lg:items-center w-full px-6"
      >
        ...
        >
          ...
          <button @click="logout" :class="className" class="focus:inline-none">
            Logout
          </button>
        </div>
